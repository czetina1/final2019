...
```
  ...
  This bar chart shows that people that are receiving the vaccine are less likely to get aids than people who received the placebo.
...
This table shows that men receiving the vaccine are less likely to get AIDS than others that are taking the placebo.
...
```
The odds of getting AIDS is 70% if the IV user is taking the vaccine than others using the placebo.
...
The conclusion is men using the vaccine are less likely to get AIDS than using the placebo. The P-value is p-value = 2.333e-07, I reject the null hypothesis due to the information provided above that shows the effectiveness of using the vaccine rather than the placebo.
